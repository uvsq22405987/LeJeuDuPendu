...
def affichage_mot():
    ...
    Afficher_mot=tk.Label(view_canvas,text=mot_cache, font=("Arial",20),width=30)
...
def jeu_pendu(mot_choisi) :
    global nb_erreurs, view_canvas, mot_cache, lettres_trouvees
    lettres_trouvees = []
    lettres_fausses = []
    nb_essais_max = 7
    nb_erreurs = 0
...
def Page_jeu():
    global root, frame, view_canvas, Nb_lettres, Longueur_texte, Afficher_mot, mot_cache, Validation_nb, Validation_lettres
    root = tk.Tk()
    ...
    view_canvas = tk.Canvas(frame, width=1200, height=600, bg="black")
    ...
    Longueur_texte=tk.Label(view_canvas,text="Choisis la longueur du mot",font=("Arial",20),width=30)
    Longueur_texte.place(x=350,y=350)

    Nb_lettres=tk.Spinbox(view_canvas, from_=4, to=10,font=("Arial",25),width=30)
    Nb_lettres.place(x=300,y=400)

    #Boutons
    Validation_nb=tk.Button(view_canvas,text="Valider le choix",command=Validation_longueur)
    Validation_nb.place(x=600,y=450)

    Validation_lettres=tk.Button(view_canvas,text="Valider la lettre",command=verification_lettres)
    Validation_lettres.place_forget()

    Indice=tk.Button(view_canvas,text="Indice", font=("Arial",15))
